...
const CommentIcon = ({ width = "28px", height = "28px", fill = "#65676b",noneStroke="none" }) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width={width}
			...
			fill={fill}
			viewBox="0 0 512 512"
			stroke={noneStroke ? noneStroke : "black"}
			strokeWidth={noneStroke ? noneStroke : 6}
		>
...
const ShareIcon = ({ width = "28px", height = "28px" }) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width={width}
